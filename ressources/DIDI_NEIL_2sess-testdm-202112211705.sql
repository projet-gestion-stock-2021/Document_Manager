...
INSERT INTO `utilisateur` VALUES (1,'Didi','Neil','neil','test1',1,1),(2,'Cauwenbergh','Eli','eli','test2',1,2),(3,'I','Ilir','ilir','test3',0,3),(4,'Dethioux','Julien','julien','test4',1,4),(5,'Delforge','Laquement','b1@gmail.com','1200a9ff9ac27eb48a215cec5fd28450',0,1);
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `insert_document`(in p_nom_document varchar(200), in p_dateDocument datetime, in p_id_creationdoc int, in p_id_type_de_document int )
begin
...
-- Dump completed on 2021-12-21 17:05:09
