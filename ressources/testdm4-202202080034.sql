...
--
-- Host: localhost    Database: testdm4
-- ------------------------------------------------------
...
INSERT INTO `type_de_document` VALUES (2,'mail',0,2),(3,'script',0,2),(4,'photo',0,3);
...
--
-- Dumping events for database 'testdm4'
--

--
-- Dumping routines for database 'testdm4'
--
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `search_document_by_name`(in p_nom varchar(50), out pathCategorie varchar(300))
begin
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `select_niveau_byID`(in p_id_niveau int)
begin
...
-- Dump completed on 2022-02-08  0:34:45
