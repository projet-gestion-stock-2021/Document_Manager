...
//    
	...
	public void initialize(URL arg0, ResourceBundle arg1) 
	{
		...
		this.tag_dossier.setItems(ctrlDossier.getListeDossier());//√† refaire, porte √† confusion
		this.tag_typeDossier.setItems(ctrlTypeDossier.getListeTypeDossier());//√† refaire, porte √† confusion
		...
		if (directoryPath != null) 
    		{
				...
				for(int i = 0; i < files.length; i++)
				{
					...
					else 
	                {
						...
						//faudrait peut-Ítre stocker le checksum dans la DB pour aller plus vite
						...
						if(tempPath != null && Files.exists(Paths.get(tempPath)))
						{
							...
							{
								System.out.println("\nMEME FICHIER non modifiÈ\n");
							}
							else
							{
								System.out.println("\nMEME nom de FICHIER peut-Ítre modifiÈ\n");
							}
